...
const getCacheKey = (question: string) => {
  ...
  // * TODO: Hash the provided string and return it
  // *******************************
...
const getFromCache = async (
  ...
  // *******************************
  // * WARNING: Solution missing
  // * TODO: Retrieve the cached value using the getCacheKey function
  // *******************************
  throw new Error("Not Implemented!");
};
...
const setToCache = async (
  ...
  // *******************************
  // * WARNING: Solution missing
  // * TODO: Store the stringified responseData in Redis using the getCacheKey function
  // *******************************
  throw new Error("Not Implemented!");
};
